...
public class NGUIUpdateManager : MonoBehaviour
{
	...
	static NGUIUpdateManager mInst;
	...
	static void CreateInstance ()
	{
		if (mInst == null)
		{
			mInst = GameObject.FindObjectOfType(typeof(NGUIUpdateManager)) as NGUIUpdateManager;
			...
			if (mInst == null && Application.isPlaying)
			{
				...
				mInst = go.AddComponent<NGUIUpdateManager>();
			}
		}
	}
