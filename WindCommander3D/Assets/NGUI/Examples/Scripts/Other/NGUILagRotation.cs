...
[AddComponentMenu("NGUI/Examples/NGUI Lag Rotation")]
public class NGUILagRotation : MonoBehaviour
{
	...
	void Start()
	{
		...
		if (ignoreTimeScale) NGUIUpdateManager.AddCoroutine(this, updateOrder, CoroutineUpdate);
        else NGUIUpdateManager.AddLateUpdate(this, updateOrder, CoroutineUpdate);
	}
